...
#                         ylabel('Relative Sensitivity','FontSize',34,'FontWeight','bold')
            ...
            mycolor = [1 0 00 1 00 0 1] # Specifies the colormap for the three segments of color from low to high.
            colormap(mycolor)
            clear mycolor
...
'''Call to Peak Finding Function Here'''
...
'''Calculation of Integration Regions?'''
    ...
    for i = 1:size(search_record,1)
        ...
        if (i/10) == round(i/10)
            ...
            waitbar(percentageDetermined,h2,{waitbar_progress_text1waitbar_progress_text2},'Name',version_string)
        end
    end
